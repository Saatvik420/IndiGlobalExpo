...
public class WebSecurityConfig {
        ...
        http.cors(cors -> cors.disable())
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers(AntPathRequestMatcher.antMatcher("/")).permitAll()
                                ...
                                .requestMatchers(AntPathRequestMatcher.antMatcher("/api/contact/all")).hasRole("ADMIN")
                                .requestMatchers(AntPathRequestMatcher.antMatcher("/api/contact/read/**")).hasRole("ADMIN")
                                .requestMatchers(AntPathRequestMatcher.antMatcher("/api/contact/**")).hasRole("ADMIN")
    ...
    // CORS is now handled by SimpleCorsFilter.java
