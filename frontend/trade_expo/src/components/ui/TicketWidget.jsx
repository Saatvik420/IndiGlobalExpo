...
const TicketWidget = () => {
  ...
  return (
    <div 
      ...
      className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[55] interactive group block cursor-none"
    >
      <div className="relative w-28 h-28 md:w-32 md:h-32 flex items-center justify-center rounded-full bg-white/10 backdrop-blur-sm border border-white/20 shadow-2xl hover:scale-105 transition-transform duration-300">
        ...
        {/* Center Icon/Button */}
        <div className="w-14 h-14 md:w-16 md:h-16 bg-brand-dark text-white rounded-full flex items-center justify-center group-hover:bg-brand-accent transition-colors shadow-inner z-10">
