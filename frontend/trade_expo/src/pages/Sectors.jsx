...
const Sectors = () => {
  ...
  return (
    <>
      ...
      <section className="relative min-h-[440px] sm:h-[65vh] flex items-center overflow-hidden bg-brand-dark py-20 sm:py-0">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full mt-12 sm:mt-16">
          <div className="max-w-3xl">
            <p className="text-brand-accent font-bold tracking-widest uppercase text-xs mb-3 sm:mb-4 animate-fade-up">Industries & Opportunities</p>
      ...
      <div className="bg-brand-light">
        {/* 1. Healthcare */}
        <section id="healthcare" className="sector-section py-12 sm:py-16 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="order-2 lg:order-1 reveal-up">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-serif text-brand-dark mt-2 mb-4 sm:mb-6">Healthcare & Medical Devices</h2>
                <p className="text-gray-500 font-light text-base sm:text-lg leading-relaxed mb-6 sm:mb-8">
                ...
                <ul className="space-y-3 sm:space-y-4 font-light text-gray-600 text-sm sm:text-base">
              ...
              <div className="order-1 lg:order-2 reveal-up delay-100">
                <img src={healthcareImg} alt="Healthcare" className="w-full h-[260px] sm:h-[340px] md:h-[400px] object-cover rounded-sm shadow-xl" />
              </div>
            </div>
          </div>
        </section>
        ...
        {/* 2. IT */}
        <section id="it" className="sector-section py-12 sm:py-16 md:py-20 bg-brand-light">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="reveal-up">
                <img src={itImg} alt="Information Technology" className="w-full h-[260px] sm:h-[340px] md:h-[400px] object-cover rounded-sm shadow-xl" />
              </div>
              <div className="reveal-up delay-100">
                <span className="text-brand-accent font-bold tracking-widest uppercase text-xs">Sector 02</span>
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-serif text-brand-dark mt-2 mb-4 sm:mb-6">Information Tech & Digital Solutions</h2>
                <p className="text-gray-500 font-light text-base sm:text-lg leading-relaxed mb-6 sm:mb-8">
        ...
        {/* 3. Food & Beverages */}
        <section id="food" className="sector-section py-12 sm:py-16 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="order-2 lg:order-1 reveal-up">
                <span className="text-brand-accent font-bold tracking-widest uppercase text-xs">Sector 03</span>
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-serif text-brand-dark mt-2 mb-4 sm:mb-6">Food & Beverages & Agri-Products</h2>
                <p className="text-gray-500 font-light text-base sm:text-lg leading-relaxed mb-6 sm:mb-8">
                ...
                <ul className="space-y-3 sm:space-y-4 font-light text-gray-600 text-sm sm:text-base">
                  ...
                  <li className="flex items-center gap-3"><i className="ph-fill ph-check-circle text-brand-accent"></i> Sustainable Agri-Tech</li>
                </ul>
              </div>
              <div className="order-1 lg:order-2 reveal-up delay-100">
                <img src={foodImg} alt="Food & Beverages" className="w-full h-[260px] sm:h-[340px] md:h-[400px] object-cover rounded-sm shadow-xl" />
              </div>
            </div>
          </div>
        </section>
        ...
        {/* 4. Textiles */}
        <section id="textiles" className="sector-section py-12 sm:py-16 md:py-20 bg-brand-light">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="reveal-up">
                <img src={textilesImg} alt="Textiles" className="w-full h-[260px] sm:h-[340px] md:h-[400px] object-cover rounded-sm shadow-xl" />
              </div>
              <div className="reveal-up delay-100">
                <span className="text-brand-accent font-bold tracking-widest uppercase text-xs">Sector 04</span>
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-serif text-brand-dark mt-2 mb-4 sm:mb-6">Textiles & Fashion Apparels</h2>
                <p className="text-gray-500 font-light text-base sm:text-lg leading-relaxed mb-6 sm:mb-8">
        ...
        {/* 5. Gems & Jewelry */}
        <section id="gems" className="sector-section py-12 sm:py-16 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="order-2 lg:order-1 reveal-up">
                <span className="text-brand-accent font-bold tracking-widest uppercase text-xs">Sector 05</span>
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-serif text-brand-dark mt-2 mb-4 sm:mb-6">Gems & Jewelry</h2>
                <p className="text-gray-500 font-light text-base sm:text-lg leading-relaxed mb-6 sm:mb-8">
              ...
              <div className="order-1 lg:order-2 reveal-up delay-100">
                <img src={gemsImg} alt="Gems & Jewelry" className="w-full h-[260px] sm:h-[340px] md:h-[400px] object-cover rounded-sm shadow-xl" />
              </div>
            </div>
          </div>
        </section>
        ...
        {/* 6. Manufacturing */}
        <section id="manufacturing" className="sector-section py-12 sm:py-16 md:py-20 bg-brand-light">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="reveal-up">
                <img src={manufacturingImg} alt="Manufacturing" className="w-full h-[260px] sm:h-[340px] md:h-[400px] object-cover rounded-sm shadow-xl" />
              </div>
              <div className="reveal-up delay-100">
                <span className="text-brand-accent font-bold tracking-widest uppercase text-xs">Sector 06</span>
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-serif text-brand-dark mt-2 mb-4 sm:mb-6">Manufacturing & Heavy Engineering</h2>
                <p className="text-gray-500 font-light text-base sm:text-lg leading-relaxed mb-6 sm:mb-8">
        ...
        {/* 7. Consumer Goods */}
        <section id="consumer" className="sector-section py-12 sm:py-16 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="order-2 lg:order-1 reveal-up">
                <span className="text-brand-accent font-bold tracking-widest uppercase text-xs">Sector 07</span>
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-serif text-brand-dark mt-2 mb-4 sm:mb-6">Consumer Goods & Handicrafts</h2>
                <p className="text-gray-500 font-light text-base sm:text-lg leading-relaxed mb-6 sm:mb-8">
              ...
              <div className="order-1 lg:order-2 reveal-up delay-100">
                <img src={consumerImg} alt="Consumer Goods" className="w-full h-[260px] sm:h-[340px] md:h-[400px] object-cover rounded-sm shadow-xl" />
              </div>
            </div>
          </div>
        </section>
      ...
      {/* CTA */}
      <section className="py-16 sm:py-20 md:py-24 bg-brand-dark text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 reveal-up">
          <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-white mb-4 sm:mb-6">Ready to expand your business?</h2>
          <p className="text-gray-400 font-light text-base sm:text-lg mb-8 sm:mb-10 reveal-up delay-100">Whether you are a buyer looking for specific goods or an exhibitor ready for the global stage, secure your pass today.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4 reveal-up delay-200">
            <button onClick={() => navigate('/tickets')} className="bg-brand-accent text-white px-8 sm:px-10 py-4 sm:py-5 text-xs sm:text-sm font-bold uppercase tracking-widest hover:bg-white hover:text-brand-dark transition-all duration-300 interactive shadow-xl">
              Get Your Tickets
            </button>
            <button onClick={() => navigate('/exhibitor')} className="border border-gray-600 text-white px-8 sm:px-10 py-4 sm:py-5 text-xs sm:text-sm font-bold uppercase tracking-widest hover:border-white transition-all duration-300 interactive">
              Exhibit With Us
            </button>
          </div>
        </div>
