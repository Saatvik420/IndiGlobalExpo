...
const Legal = () => {
  ...
  return (
    <>
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-white border-b border-gray-100 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-8 sm:gap-16">
            
            {/* Sticky Sidebar Navigation */}
            <div className="w-full md:w-1/3 lg:w-1/4 reveal-up">
              <div className="sticky top-28 sm:top-32 bg-brand-light p-6 sm:p-8 border border-gray-100 rounded-sm">
                <h4 className="font-serif text-lg sm:text-xl text-brand-dark mb-4 sm:mb-6">Contents</h4>
                <ul className="space-y-3 sm:space-y-4 text-xs sm:text-sm font-light text-gray-500">
            ...
            <div className="w-full md:w-2/3 lg:w-3/4 reveal-up delay-100">
              <div className="prose prose-lg text-gray-500 font-light max-w-none text-sm sm:text-base">
                
                <div id="publisher" className="mb-10 sm:mb-16 scroll-mt-28 sm:scroll-mt-32">
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    <Buildings weight="fill" className="text-xl sm:text-2xl text-brand-accent flex-shrink-0" />
                    <h3 className="font-serif text-xl sm:text-2xl md:text-3xl text-brand-dark m-0">1. Publisher Information</h3>
                  </div>
                ...
                <div id="intellectual" className="mb-10 sm:mb-16 scroll-mt-28 sm:scroll-mt-32">
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    <Copyright weight="fill" className="text-xl sm:text-2xl text-brand-accent flex-shrink-0" />
                    <h3 className="font-serif text-xl sm:text-2xl md:text-3xl text-brand-dark m-0">2. Intellectual Property Rights</h3>
                  </div>
                  <p className="leading-relaxed">
                ...
                <div id="liability" className="mb-10 sm:mb-16 scroll-mt-28 sm:scroll-mt-32">
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    <WarningCircle weight="fill" className="text-xl sm:text-2xl text-brand-accent flex-shrink-0" />
                    <h3 className="font-serif text-xl sm:text-2xl md:text-3xl text-brand-dark m-0">3. Disclaimer of Liability</h3>
                  </div>
                  <p className="leading-relaxed">
                ...
                <div id="links" className="mb-10 sm:mb-16 scroll-mt-28 sm:scroll-mt-32">
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    <Link weight="fill" className="text-xl sm:text-2xl text-brand-accent flex-shrink-0" />
                    <h3 className="font-serif text-xl sm:text-2xl md:text-3xl text-brand-dark m-0">4. External Links</h3>
                  </div>
                  <p className="leading-relaxed">
                ...
                <div id="law" className="scroll-mt-28 sm:scroll-mt-32">
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    <Scales weight="fill" className="text-xl sm:text-2xl text-brand-accent flex-shrink-0" />
                    <h3 className="font-serif text-xl sm:text-2xl md:text-3xl text-brand-dark m-0">5. Applicable Law & Jurisdiction</h3>
                  </div>
                  <p className="leading-relaxed">
